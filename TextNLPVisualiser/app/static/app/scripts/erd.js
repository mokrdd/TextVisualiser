function draw(arr) {
    ...
    arr.forEach((element) => {
        var main = new erd.Entity({
            position: { x: x += 150, y: y },
            attrs: {
                text: {
                    text: element.from.raw,
                    letterSpacing: 0,
        ...
        var relation = new erd.Relationship({
        ...
        graph.addCells([main, relation, depend]);
        createLink(main, relation);
        createLink(relation, depend);
